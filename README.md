...
Implementation lives in [`raiden/`](raiden/README.md).
...
See [raiden/docs/ARCHITECTURE.md](raiden/docs/ARCHITECTURE.md).

---

## Stage I: Behavioral Post-Training

The first development stage focuses on behavioral and identity post-training. It does **not** retrain general coding, reasoning, or world knowledge from scratch.
...
| Document | Contents |
| -------- | -------- |
| [Identity](raiden/docs/IDENTITY.md) | Behavioral specification |
| [Architecture](raiden/docs/ARCHITECTURE.md) | Intelligence, memory, tools, runtime |
